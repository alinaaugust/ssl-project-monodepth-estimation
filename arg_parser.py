...
class MonodepthOptions:
    def __init__(self):
        self.parser = argparse.ArgumentParser(
            description="Monodepth estimation options"
        )
        ...
        self.parser.add_argument(
            "--model_name", type=str, help="the name of the model to use", default="mdp"
        )
        self.parser.add_argument(
            "--split",
            type=str,
            help="which training split to use",
            choices=["eigen_zhou", "eigen_full", "odom", "benchmark", "small_version"],
            # default="eigen_zhou",
            default='small_version',
        )
        self.parser.add_argument(
            "--num_layers",
            type=int,
        ...
        self.parser.add_argument(
            "--device",
            help="defines whether to use gpu or cpu",
            default="cuda",
            choices=["cpu", "cuda"],
        )
        self.parser.add_argument(
        ...
        # LOADING options
        self.parser.add_argument(
            "--weights_dir", type=str, help="name of model to load"
        )
        self.parser.add_argument(
            "--models_to_load",
            nargs="+",
